...
At the submission deadline on June 16, 2026, additional submissions will be locked. From June 16, 2026 for approximately two weeks, we will continue to run games. At the conclusion of this period, the leaderboard is final.
...
See the game rules above for full rules and configuration defaults.
...
You'll need a Kaggle account — sign up at [kaggle.com](https://www.kaggle.com) if you don't have one. Then download your API credentials at [kaggle.com/settings/api](https://www.kaggle.com/settings/api) by clicking "Generate New Token" under the "API" section.
...
Before submitting, you must accept the rules on the Kaggle website. Navigate to [kaggle.com/competitions/maze-crawler](https://www.kaggle.com/competitions/maze-crawler) and click "Join Competition".
